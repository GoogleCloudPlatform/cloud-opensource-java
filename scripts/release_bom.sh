...
mvn org.codehaus.mojo:versions-maven-plugin:2.7:versions:set org.codehaus.mojo:versions-maven-plugin:2.7:versions:commit -DnewVersion=${VERSION} -DgenerateBackupPoms=false
...
mvn org.codehaus.mojo:versions-maven-plugin:2.7:versions:set org.codehaus.mojo:versions-maven-plugin:2.7:versions:commit -DnewVersion=${NEXT_SNAPSHOT} -DgenerateBackupPoms=false
