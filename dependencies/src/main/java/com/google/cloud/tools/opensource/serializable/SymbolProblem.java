  ...
  public final String toString() {
    String jarInfo =
        containingClass != null
            ? String.format("(%s) ", containingClass.getCoordinates())
            : "";
    return jarInfo + getErrorType().getMessage(symbol.toString()) + " (type: " +getErrorType()+")";
  }
            ...
            (problem, classFiles) -> {
              ...
              classFiles.forEach(
                  classFile -> {
                    ...
                    output.append(" (" + classFile.getCoordinates() + ")\n");
                  });
            });
