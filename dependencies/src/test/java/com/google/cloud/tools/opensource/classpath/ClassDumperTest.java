...
import static com.google.cloud.tools.opensource.classpath.LinkageCheckerTest.resolve;
...
public class ClassDumperTest {
  ...
  public void testMapJarToClasses_classWithDollars() throws IOException {
    List<ClassPathEntry> classPath = resolve("com.google.code.gson:gson:2.6.2");
