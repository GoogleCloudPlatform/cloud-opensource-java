...
public class SymbolReferenceMapsTest {
  ...
  private ClassFile sourceClass = new ClassFile(new AnnotatedJar(path), "com.google.Foo");
  ...
  public void testEquality() {
    ...
    ClassFile sourceClass2 = new ClassFile(new AnnotatedJar(path), "com.google.Bar");
